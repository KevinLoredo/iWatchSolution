        ...
        <div class="container-fluid">
            ...
            <div id="navbar"class="navbar-collapse collapse">
                <ul class="nav navbar-nav">                    
                    ...
                    if (ControlSesion::sesion_iniciada()) {
                        ?>                        
                        <li><a href="<?php echo RUTA_CREAR_NOTAS ?>"><i class="fas fa-sticky-note"></i></i> Crear Notas</a></li>
                        <li><a href="<?php echo RUTA_LISTA_NOTAS ?>"><i class="fas fa-clipboard-list"></i> Listas Notas</a></li>
                        <?php
                    } else {
                        ?>
                        <li><a href=" <?php echo RUTA_LOGIN_ADMIN ?>"><i class="fas fa-user"></i> Admin</a></li>
