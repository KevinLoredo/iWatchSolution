        ...
        <div class="col-md-7">
            ...
            <div class="col-md-9">
                <div class="input-group input-group-lg">
                    ...
                    <input type="text" name="guiaenvio" class="form-control" placeholder="GUIA DE ENVIO" <?php $validador->Mostrar_GuiaEnvio() ?>
                       aria-describedby="sizing-addon1">
                       <?php
                       $validador->MostrarErrorGuiaEnvio();
                       ?>
                </div>
                <br>
                <br>
            ...
            <div class="col-md-12">
                <div class="input-group input-group-lg">
                    ...
                    <input type="text" name="nombre" class="form-control" placeholder="Nombre Del Cliente" <?php $validador->Mostrar_Nombre() ?>
                       aria-describedby="sizing-addon1">
                       <?php
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="input-group input-group-lg">
                ...
                <input type="text" name="modelo" class="form-control" placeholder="Modelo" <?php $validador->Mostrar_Modelo() ?>
                       aria-describedby="sizing-addon1">
                       <?php
                       $validador->MostrarErrorModelo();
                       ?>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="input-group input-group-lg">
                ...
                <input type="text" name="imei" class="form-control" placeholder="IMEI" <?php $validador->Mostrar_IMEI() ?>
                       aria-describedby="sizing-addon1">
                       <?php
                       $validador->MostrarErrorIMEI();
                       ?>
            </div>
        </div>
    </div>
